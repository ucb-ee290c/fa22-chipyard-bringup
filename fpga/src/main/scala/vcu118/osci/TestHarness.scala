...
class OsciVCU118FPGATestHarness(override implicit val p: Parameters) extends VCU118FPGATestHarness {
  ...
  val uart_fmc = Overlay(UARTOverlayKey, new OsciUARTVCU118ShellPlacer(this, UARTShellInput()))
  ...
  val i2c = Overlay(I2COverlayKey, new OsciI2CVCU118ShellPlacer(this, I2CShellInput()))
  ...
  val gpio = Seq.tabulate(dp(PeripheryGPIOKey).size)(i => {
    ...
    val names = OsciGPIOs.names.slice(maxGPIOSupport*i, maxGPIOSupport*(i+1))
    Overlay(GPIOOverlayKey, new OsciGPIOVCU118ShellPlacer(this, GPIOShellInput(), names))
  })
  ...
  val tsi_host = Overlay(TSIHostOverlayKey, new OsciTSIHostVCU118ShellPlacer(this, TSIHostShellInput()))
  ...
  override lazy val module = new OsciVCU118FPGATestHarnessImp(this)
}

class OsciVCU118FPGATestHarnessImp(_outer: OsciVCU118FPGATestHarness) extends VCU118FPGATestHarnessImp(_outer) {
  lazy val osciOuter = _outer
}
